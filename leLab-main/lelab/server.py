...
from .gamepad_debug import handle_gamepad_status
from .jobs import (
...
def gamepad_status():
    """Live gamepad detection + axis/button/hat values, independent of any
    active teleoperation session -- the GUI equivalent of gamepad_debug.py."""
    return handle_gamepad_status()
...
if FRONTEND_DIST.exists():
    ...
    logger.warning(
        f"frontend/dist not found at {FRONTEND_DIST}; run `npm run build` in frontend/ or use `lelab-gamepad --dev`."
    )
