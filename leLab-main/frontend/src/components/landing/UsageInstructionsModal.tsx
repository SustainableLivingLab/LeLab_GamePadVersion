      ...
      >
        <DialogHeader className="text-center sm:text-center min-w-0">
          <DialogTitle className="text-white flex items-center justify-center gap-2 text-xl">
            ...
            Get Started with LeLab GamePad Version
          </DialogTitle>
          <DialogDescription>
            LeLab GamePad Version runs on your machine. Click the command to
            copy it, then paste in a terminal:
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-2 min-w-0">
          ...
          <p className="text-gray-400 text-sm text-center">
            After running, your browser will open the local LeLab GamePad
            Version app.
          </p>
          <Button
            asChild
